...
@Component({
  selector: 'app-add-edit-corredoruser',
  templateUrl: './add-edit-corredoruser.component.html',
  styleUrls: ['./add-edit-corredoruser.component.css']
})
export class AddEditCorredoruserComponent implements OnInit, OnChanges {
