...
@Component({
  selector: 'app-corredoruser',
  templateUrl: './corredoruser.component.html',
  styleUrls: ['./corredoruser.component.css'],
  providers: [MessageService,ConfirmationService]
})
export class CorredoruserComponent implements OnInit {
