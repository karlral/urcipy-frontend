...
@Component({
  selector: 'app-list-anual-historial',
  templateUrl: './list-anual-historial.component.html',
  styleUrls: ['./list-anual-historial.component.css'],
  providers: [MessageService]
})
export class ListAnualHistorialComponent implements OnInit{
  ...
  constructor( private historialService: HistorialService,
    ...
    ngOnInit(): void {
      console.log('Buscamos la cantidad de registros en el año ');
   
      this.historialService.listarHistorialAnual().subscribe(
        {
